...
function Myportfolios() {
  ...
  for (let i = 0; i < data.length; i += 3) {
    ...
    for (let k = 0; k < 3 && i + k < data.length; k++) {
      ...
      i_grid.push(
        <Grid style={{ display: "flex", flexDirection: "column" }} key={i + k}>
          <div className="rows">
            <div style={{ position: "relative" }}>
              <img src={data1.pic} className="images" />
              <div
                className="protfolioImageHover"
                style={{
                  position: "absolute",
                  width: "100%",
                  height: "100%",
                ...
                >
                  ...
                  {data1.link === "#" ? (
                    ...
                    <a href={data1.link} target="_blank">
                      <button className="magnifier">{data1.linkicon}</button>
                    </a>
                  )}
                </div>
              </div>
            ...
            <div className="portfolio-name">
              <a
                href={data1.link}
                target="_blank"
                className="portfolio-name-hover"
              >
                {data1.portfolioname}
              </a>
            </div>
  ...
  const modalSliderImages = UserData.portfoliodata[showIndex].pics.map(
    (arr) => (
      <>
        <div className="app-name">
          <span>{UserData.portfoliodata[showIndex].portfolioname}</span>
        </div>
      ...
      <div className="port">
        <Grid container style={{ display: "flex", flexDirection: "column" }}>
          <div
            style={{
              width:
                Math.max((winSize.width ? winSize.width : 0) - 700, 300) + "px",
            }}
          >
      ...
      >
        <Grid container>
          <div className="image-div">
            <div
              style={{ width: Math.max(winSize.width / 1.3 - 200, 300) + "px" }}
            >
              <Grid>
              ...
              <div className="description">
                <div className="inner-text">
                  ...
                  <span style={{ fontSize: "13px", fontWeight: 400 }}>
                    {UserData.portfoliodata[showIndex].description}
                  </span>
                </div>
                <div className="about-project">
                  ...
                  <span style={{ fontSize: "13px", fontWeight: 400 }}>
                    {UserData.portfoliodata[showIndex].aboutPortfolio}
                  </span>
                </div>
              </div>
            </div>
