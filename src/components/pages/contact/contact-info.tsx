  ...
  if(winSize.width < 600)
  {
    ...
    const onSubmit = async () => {
        const data = {
            ...
            "phone": phone,
            "message": message,
            "sender": "abdulrehmanmirza135@gmail.com",
            "recepient": ['abdulrehmanmirza135@gmail.com', 'ar.rehmanmirza@gmail.com']
        };
    ...
    return (
        <div className='subabout'>
            ...
            <Grid container className="myinfo" style={{ fontSize: 18 }}>
                    ...
                    <div style={{ width: '100%', flexDirection: 'row', alignItems: 'center' }}>
                        <div className='form'>
                            <form className={classes.root} autoComplete="off" onSubmit={handleSubmit(onSubmit)}  >
                                ...
                                <TextareaAutosize placeholder="Enter your Message" style={{ margin: '8px', width: 'calc(100% - 15%)', minHeight: '100px', borderColor: '#cbced8' }} 
                ...
                <Grid xs={12} sm={12} md={6} style={{ display: 'flex', flexDirection: 'column' }}>
                    <div>
